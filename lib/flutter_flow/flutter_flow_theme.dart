...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color secondary = const Color(0xFFED0C9D);
  late Color tertiary = const Color(0xFF14181B);
  late Color alternate = const Color(0x3FAEAEAE);
  late Color primaryText = const Color(0xFF0A0A0A);
  late Color secondaryText = const Color(0xFF57636C);
  late Color primaryBackground = const Color(0xFFF1F4F8);
  late Color secondaryBackground = const Color(0xFFE0E3E7);
  late Color accent1 = const Color(0xFF0873DD);
  late Color accent2 = const Color(0xFFFF106C);
  late Color accent3 = const Color(0xFFEAD5E6);
  late Color accent4 = const Color(0xFFFFFFFF);
  late Color success = const Color(0xFFED0C9D);
  late Color warning = const Color(0xFFF3B212);
  late Color error = const Color(0xFFFF101F);
  late Color info = const Color(0xFF717171);
}
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color secondary = const Color(0xFFED0C9D);
  late Color tertiary = const Color(0xFFEAD5E6);
  ...
  late Color accent2 = const Color(0xFFFF106C);
  late Color accent3 = const Color(0xFFEAD5E6);
  late Color accent4 = const Color(0x96202020);
  late Color success = const Color(0xFFED0C9D);
  late Color warning = const Color(0xFFF3B212);
  late Color error = const Color(0xFFFF101F);
  late Color info = const Color(0xFF717171);
