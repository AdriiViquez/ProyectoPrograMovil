...
class _EditProfileWidgetState extends State<EditProfileWidget> {
  ...
  void initState() {
    ...
    _model.txtLastNameTextController ??= TextEditingController(
        text: valueOrDefault(currentUserDocument?.firstLastName, ''));
    _model.txtLastNameFocusNode ??= FocusNode();

    _model.txtsecondLastNameTextController ??= TextEditingController(
        text: valueOrDefault(currentUserDocument?.secondLastName, ''));
    ...
    _model.txtEmailTextController3 ??= TextEditingController(
        text: valueOrDefault(currentUserDocument?.address, ''));
    _model.txtEmailFocusNode3 ??= FocusNode();
  }
                                ...
                                children: [
                                  Padding(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        Text(
                                          'You can update your image here',
                                          style: FlutterFlowTheme.of(context)
                                              .bodyMedium
                                              .override(
                                                fontFamily: 'Inter',
                                        ...
                                        Expanded(
                                          child: AuthUserStreamWidget(
                                            builder: (context) => SizedBox(
                                              ...
                                              child: TextFormField(
                                                controller: _model
                                                    .txtEmailTextController3,
                                                focusNode:
                                                    _model.txtEmailFocusNode3,
                                                autofocus: false,
                                                obscureText: false,
                                                decoration: InputDecoration(
                                                  isDense: true,
                                                ...
                                                cursorColor:
                                                    FlutterFlowTheme.of(context)
                                                        .primaryText,
                                                validator: _model
                                                    .txtEmailTextController3Validator
                                                    .asValidator(context),
                                              ),
                                            ),
                                          ),
