                        ...
                        return Slidable(
                              ...
                              SlidableAction(
                                ...
                                onPressed: (_) async {
                                  context.pushNamed(
                                    'EditUser',
                                    queryParameters: {
                                      'paramUser': serializeParam(
                                        listViewUsersRecord,
                                        ParamType.Document,
                                      ),
                                    }.withoutNulls,
                                    extra: <String, dynamic>{
                                      'paramUser': listViewUsersRecord,
                                    },
                                  );
                                },
                              ),
                          ...
                          child: Material(
                            ...
                            child: ListTile(
                              title: Text(
                                valueOrDefault<String>(
                                  '${valueOrDefault<String>(
                                    ...
                                    'defaultName',
                                  )}${listViewUsersRecord.firstLastName}',
                                  'default  name',
                                ),
                                style: FlutterFlowTheme.of(context)
                                    .titleLarge
                              ...
                              subtitle: Text(
                                valueOrDefault<String>(
                                  'Emai: ${listViewUsersRecord.email} Status:  ${listViewUsersRecord.status}',
                                  'status',
                                ),
                                style: FlutterFlowTheme.of(context)
                                    .labelMedium
