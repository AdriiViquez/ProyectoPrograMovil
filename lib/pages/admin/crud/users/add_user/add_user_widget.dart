                                        ...
                                        children: [
                                          Expanded(
                                            child: SizedBox(
                                              ...
                                              child: TextFormField(
                                                controller: _model
                                                    .txtAddressTextController,
                                                focusNode:
                                                    _model.txtAddressFocusNode,
                                                autofocus: false,
                                                obscureText: false,
                                                decoration: InputDecoration(
                                                  isDense: true,
                                        ...
                                        children: [
                                          Expanded(
                                            child: SizedBox(
                                              ...
                                              child: TextFormField(
                                                controller: _model
                                                    .txtPasswordConfirmTextController,
                                                focusNode: _model
                                                    .txtPasswordConfirmFocusNode,
                                                autofocus: false,
                                                obscureText: !_model
                                                    .txtPasswordConfirmVisibility,
                                                decoration: InputDecoration(
                                                  isDense: true,
                                                  labelStyle:
                                                      FlutterFlowTheme.of(
                                            ...
                                            child: FFButtonWidget(
                                              onPressed: () async {
                                                ...
                                                if (_model.dropDownValue1 !=
                                                  ...
                                                  context
                                                      .pushNamed('UsersAdmin');
                                                } else {
                                                  ScaffoldMessenger.of(context)
                                                      .showSnackBar(
                                                    SnackBar(
                                                      content: Text(
                                                        'Yout must select an Status',
                                                        style: TextStyle(
                                                          color: FlutterFlowTheme
                                                                  .of(context)
                                                              .primaryText,
