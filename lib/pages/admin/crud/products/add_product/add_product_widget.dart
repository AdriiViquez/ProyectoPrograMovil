                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Padding(
                                      ...
                                      child: Builder(
                                        builder: (context) {
                                          final images = _model.uploadedFileUrls
                                              .map((e) => e)
                                              .toList();
                                          ...
                                          Expanded(
                                            child: FFButtonWidget(
                                              onPressed: () async {
                                                ...
                                                _model.collectionIdReference =
                                                    await actions
                                                        .getCollectionIdReference(
                                                  _model.dprCollectionValue,
                                                );
                                                shouldSetState = true;
                                                _model.categoryIdReference =
                                                    await actions
                                                        .getCategoryIdReference(
                                                  _model.dprCategoryValue1,
                                                );
                                                shouldSetState = true;
                                                _model.providerIdReference =
                                                    await actions
                                                        .getProviderIdReference(
                                                  _model.dprCategoryValue2,
                                                );
                                                shouldSetState = true;
