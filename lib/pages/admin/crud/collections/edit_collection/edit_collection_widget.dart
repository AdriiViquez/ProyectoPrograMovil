...
class EditCollectionWidget extends StatefulWidget {
  /// this is a Page to Update a collection in the store
  const EditCollectionWidget({
    super.key,
    required this.paramCollection,
  });

  final CollectionRecord? paramCollection;
...
class _EditCollectionWidgetState extends State<EditCollectionWidget> {
  ...
  void initState() {
    ...
    _model.txtCollectionNameTextController ??=
        TextEditingController(text: widget.paramCollection?.name);
    _model.txtCollectionNameFocusNode ??= FocusNode();

    _model.txtCollectionDescriptionTextController ??=
        TextEditingController(text: widget.paramCollection?.description);
    _model.txtCollectionDescriptionFocusNode ??= FocusNode();
  }
                                        ...
                                        children: [
                                          Expanded(
                                            child: SizedBox(
                                              ...
                                              child: TextFormField(
                                                controller: _model
                                                    .txtCollectionNameTextController,
                                                focusNode: _model
                                                    .txtCollectionNameFocusNode,
                                                autofocus: false,
                                                obscureText: false,
                                        ...
                                        children: [
                                          Expanded(
                                            child: SizedBox(
                                              ...
                                              child: TextFormField(
                                                controller: _model
                                                    .txtCollectionDescriptionTextController,
                                                focusNode: _model
                                                    .txtCollectionDescriptionFocusNode,
                                                autofocus: false,
                                                obscureText: false,
                                                decoration: InputDecoration(
                                                  isDense: true,
                                        ...
                                        children: [
                                          Expanded(
                                            child: FlutterFlowDropDown<String>(
                                              controller: _model
                                                      .dprdStatusValueController ??=
                                                  FormFieldController<String>(
                                                _model.dprdStatusValue ??=
                                                    valueOrDefault<String>(
                                                  widget
                                                      .paramCollection?.status,
                                                  'Active',
                                                ),
                                              ),
                                          ...
                                          Expanded(
                                            child: FFButtonWidget(
                                              onPressed: () async {
                                                ...
                                                if (_model.dprdStatusValue ==
                                                    null) {
                                                  return;
                                                }

                                                await widget
                                                    .paramCollection!.reference
                                                    .update(
