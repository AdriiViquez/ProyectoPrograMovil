...
class EditCategoryWidget extends StatefulWidget {
  ...
  final CategoryRecord? paramCategory;
...
class _EditCategoryWidgetState extends State<EditCategoryWidget> {
  ...
  void initState() {
    ...
    _model.txtCategoryNameTextController ??=
        TextEditingController(text: widget.paramCategory?.name);
                                          ...
                                          children: [
                                            Expanded(
                                              child: SizedBox(
                                                ...
                                                child: TextFormField(
                                                  controller: _model
                                                      .txtCategoryNameTextController,
                                                  focusNode: _model
                                                      .txtCategoryNameFocusNode,
                                                  autofocus: false,
                                                  obscureText: false,
                                          ...
                                          children: [
                                            Expanded(
                                              child:
                                                ...
                                                controller: _model
                                                        .dprCategoryStatusValueController ??=
                                                    FormFieldController<String>(
                                                  _model.dprCategoryStatusValue ??=
                                                      widget.paramCategory
                                                          ?.status,
                                                ),
                                                options: const ['Active', 'Inactive'],
                                                onChanged: (val) =>
                                                    safeSetState(() => _model
                                                            .dprCategoryStatusValue =
                                                        val),
                                                width: 200.0,
                                                height: 40.0,
                                                textStyle:
