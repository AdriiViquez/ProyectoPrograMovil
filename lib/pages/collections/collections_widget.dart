                              ...
                              return SizedBox(
                                ...
                                child: Autocomplete<String>(
                                  ...
                                  optionsBuilder: (textEditingValue) {
                                    ...
                                    return txtSearchCollectionRecordList
                                        .map((e) => e.name)
                                        .toList()
                                        .where((option) {
                    ...
                    StreamBuilder<List<CollectionRecord>>(
                      stream: queryCollectionRecord(
                        queryBuilder: (collectionRecord) =>
                          ...
                          'name',
                          isEqualTo: _model.txtSearchTextController.text != ''
                      ...
                      builder: (context, snapshot) {
                        ...
                        List<CollectionRecord>
                            listViewCollectionsCollectionRecordList =
                            snapshot.data!;
                        ...
                        return ListView.builder(
                          ...
                          itemCount:
                              listViewCollectionsCollectionRecordList.length,
                          itemBuilder: (context, listViewCollectionsIndex) {
                            final listViewCollectionsCollectionRecord =
                                listViewCollectionsCollectionRecordList[
                                    listViewCollectionsIndex];
                            return Padding(
                              padding: const EdgeInsetsDirectional.fromSTEB(
                                  5.0, 20.0, 5.0, 10.0),
                              child: Container(
                                ...
                                child: InkWell(
                                  ...
                                  onTap: () async {
                                    context.pushNamed(
                                      'ProductsCollection',
                                      queryParameters: {
                                        'collectionCollection': serializeParam(
                                          listViewCollectionsCollectionRecord,
                                          ParamType.Document,
                                        ),
                                      }.withoutNulls,
