  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<ProductRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<ProductRecord> detailsProductProductRecordList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final detailsProductProductRecord =
            detailsProductProductRecordList.isNotEmpty
                ? detailsProductProductRecordList.first
                : null;
                                              ...
                                              child: Padding(
                                                ...
                                                child: FFButtonWidget(
                                                  onPressed: () async {
                                                    ...
                                                    _model.productToCart2 =
                                                        await actions
                                                            .processProductDatatoCart(
                                                      widget.paramProduct!,
                                                    );
                                                    shouldSetState = true;
                                                    _model.productExistsInCart2 =
                                            ...
                                            Expanded(
                                              child: Padding(
                                                ...
                                                child: FFButtonWidget(
                                                  onPressed: () async {
                                                    var shouldSetState = false;
                                                    _model.productToCart =
                                                        await actions
                                                            .processProductDatatoCart(
                                                      widget.paramProduct!,
                                                    );
                                                    shouldSetState = true;
                                                    _model.productExistsInCart =
                                                        await queryCartRecordOnce(
                                                      queryBuilder:
                                                          (cartRecord) =>
                                                              cartRecord.where(
