                                  ...
                                  Padding(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          '${widget.paramProduct?.price.toString()}\$',
                                          style: FlutterFlowTheme.of(context)
                                              .bodyMedium
                                              .override(
                                                fontFamily: 'Inter',
                                    ...
                                    children: [
                                      Expanded(
                                        child: Padding(
                                          ...
                                          child: Text(
                                            valueOrDefault<String>(
                                              widget.paramProduct?.description,
                                              'default description',
                                            ),
                                            style: FlutterFlowTheme.of(context)
                                                .bodyMedium
                                              ...
                                              onPressed: () async {
                                                ...
                                                await cartRecordReference
                                                  ...
                                                  subtotal: widget
                                                      .paramProduct?.price,
                                                  producto: widget
                                                      .paramProduct?.reference,
                                                  quantity: 1,
                                                ));
                                                _model.productoAgregado =
                                                    CartRecord
                                                        .getDocumentFromData(
