...
import 'change_my_password_model.dart';
export 'change_my_password_model.dart';

class ChangeMyPasswordWidget extends StatefulWidget {
  const ChangeMyPasswordWidget({super.key});

  @override
  State<ChangeMyPasswordWidget> createState() => _ChangeMyPasswordWidgetState();
}

class _ChangeMyPasswordWidgetState extends State<ChangeMyPasswordWidget> {
  late ChangeMyPasswordModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ChangeMyPasswordModel());
