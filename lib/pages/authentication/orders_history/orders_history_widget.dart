                        ...
                        child: Container(
                          ...
                          child: Column(
                            ...
                            children: [
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    Expanded(
                                      ...
                                      child: Text(
                                        '${valueOrDefault<String>(
                                          listViewSalesRecord.total.toString(),
                                          '0',
                                        )} \$',
                              ...
                              Builder(
                                builder: (context) {
                                  if (listViewSalesRecord.status == 'Pending') {
                                    return Padding(
                                      padding: const EdgeInsetsDirectional.fromSTEB(
                                          16.0, 2.0, 0.0, 12.0),
                                      child: Text(
                ...
                child: Padding(
                  ...
                  child: StreamBuilder<List<SalesRecord>>(
                    ...
                    builder: (context, snapshot) {
                      ...
                      List<SalesRecord> rowSalesRecordList = snapshot.data!;

                      return Row(
                        mainAxisSize: MainAxisSize.max,
                        mainAxisAlignment: MainAxisAlignment.center,
                        children: List.generate(rowSalesRecordList.length,
                            (rowIndex) {
                          final rowSalesRecord = rowSalesRecordList[rowIndex];
                          return Visibility(
                            visible:
                                currentUserReference != rowSalesRecord.userRef,
                            child: Expanded(
                              child: Padding(
