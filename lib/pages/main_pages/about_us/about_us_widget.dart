                  ...
                  children: [
                    ...
                    Flexible(
                      child: Padding(
                        ...
                        child: Text(
                          'Welcome to GeekCo, your online destination for all anime things ! We are a store created by and for anime lovers, dedicated to offering you a wide variety of products inspired by your favorite series, movies and characters.',
                ...
                children: [
                  Flexible(
                    child: Padding(
                      ...
                      child: Text(
                        'From collectible figures, themed clothes and accessories,  posters, backpacks , figures manga . You\'ll find everything you need to show your passion for anime here. Each product has been carefully selected to guarantee quality and authenticity, because we know that every detail counts for true fans.\n\nOur goal is to be more than a store: we want to be a meeting point for a community that shares the same love for the stories, worlds, and characters that make anime so special.',
                        style: FlutterFlowTheme.of(context).bodyMedium.override(
                              fontFamily: 'Inter',
                              fontSize: 14.0,
                              letterSpacing: 0.0,
