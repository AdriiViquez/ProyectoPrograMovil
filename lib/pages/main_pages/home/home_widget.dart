              ...
              children: [
                      ...
                      Expanded(
                        child: StreamBuilder<List<ProductRecord>>(
                          ...
                          builder: (context, snapshot) {
                            ...
                            List<ProductRecord> pageViewProductRecordList =
                                snapshot.data!;
                                ...
                                children: [
                                  Padding(
                                    ...
                                    child: PageView.builder(
                                      ...
                                      itemCount:
                                          pageViewProductRecordList.length,
                                                ...
                                                initialPage: max(
                                                    ...
                                                    min(
                                                        ...
                                                        pageViewProductRecordList
                                                                .length -
                                                            1))),
                                        count: pageViewProductRecordList.length,
                ...
                Column(
                  ...
                  children: [
                    ...
                    Padding(
                      padding:
                          const EdgeInsetsDirectional.fromSTEB(5.0, 32.0, 5.0, 10.0),
                      child: Container(
                        width: double.infinity,
                        decoration: BoxDecoration(
                          color: FlutterFlowTheme.of(context).primary,
                                            ...
                                            Expanded(
                                              child: ClipRRect(
                                                borderRadius:
                                                    BorderRadius.circular(8.0),
                                                child: Image.network(
                                                  'https://i.ibb.co/vmBqM42/manga-banner-webcast-ori-20.jpg',
                                                  width:
                                                      MediaQuery.sizeOf(context)
                                                              .width *
                                                          1.0,
