                            ...
                            child: Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  ClipRRect(
                                    ...
                                    child: Image.network(
                                      valueOrDefault<String>(
                                        containerProductRecord?.images.first,
                                        '\$',
                                      ),
                                      width: 40.0,
                                      height: 40.0,
                                  ...
                                  if (listViewCartRecord.quantity > 1)
                                    InkWell(
                                      splashColor: Colors.transparent,
                                      focusColor: Colors.transparent,
                                      hoverColor: Colors.transparent,
                                      ...
                                      onTap: () async {
                                        await listViewCartRecord.reference
                                          ...
                                          ...createCartRecordData(
                                            subtotal: functions.restaProducto(
                                                listViewCartRecord.subtotal,
                                  ...
                                  InkWell(
                                    ...
                                    onTap: () async {
                                      await listViewCartRecord.reference
                                          .update({
                                        ...createCartRecordData(
                                          subtotal: functions.sumarProducto(
                                              listViewCartRecord.subtotal,
                                              containerProductRecord!.price),
                                        ),
                                        ...mapToFirestore(
                        ...
                        children: [
                          ...
                          StreamBuilder<List<CartRecord>>(
                            ...
                            builder: (context, snapshot) {
                              ...
                              List<CartRecord> txtBasePriceCartRecordList =
                                  snapshot.data!;

                              return Text(
                                formatNumber(
                                  functions.totalList(txtBasePriceCartRecordList
                                      .map((e) => e.subtotal)
                                      .toList()),
                        ...
                        children: [
                          ...
                          StreamBuilder<List<CartRecord>>(
                            ...
                            builder: (context, snapshot) {
                              ...
                              List<CartRecord> txtTotalCartRecordList =
                                  snapshot.data!;

                              return Text(
                                formatNumber(
                                  functions.totalListPlusTax(
                                      txtTotalCartRecordList
                                          .map((e) => e.subtotal)
                                          .toList()),
                                  formatType: FormatType.decimal,
                                  decimalType: DecimalType.automatic,
